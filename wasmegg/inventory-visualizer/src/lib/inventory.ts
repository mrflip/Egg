...
const DEFAULT_ASPECTS_ORDER: Orderables = {
  ...
  byStoningT1:  { name: 'Stone Family 1',    weight:  5, grain: 2, area: 'stg', id: 'byStoningF1',              img: hackyIconUrl('afx_clarity_stone_4.png') },
  byStoningT2:  { name: 'Stone Family 2',    weight:  6, grain: 2, area: 'stg', id: 'byStoningF2',              img: hackyIconUrl('afx_clarity_stone_3.png') },
  byStoningL1:  { name: 'Stone 1 Tier',      weight:  7, grain: 2, area: 'stl', id: 'byStoningT1',              img: hackyIconUrl('afx_clarity_stone_2.png') },
  byStoningL2:  { name: 'Stone 2 Tier',      weight:  8, grain: 2, area: 'stl', id: 'byStoningT2',              img: hackyIconUrl('afx_clarity_stone_1.png') },
...
const Sorters: { [key:string]: SorterFunc }  = {
  ...
  byStoningT1(item: GridItem, lo: LayoutOrderables) { return byStoningTier(item, 0, lo) },
  byStoningT2(item: GridItem, lo: LayoutOrderables) { return byStoningTier(item, 1, lo) },
  // byStoningL3(item: GridItem, lo: LayoutOrderables) { return (byStoningLvlOrder(item, 0) * 1e6, lo) },
  byStoningF1(item: GridItem, lo: LayoutOrderables) { return byStoningFamily(item, 0, lo) },
  byStoningF2(item: GridItem, lo: LayoutOrderables) { return byStoningFamily(item, 1, lo) },
}

function byStoningTier(item: GridItem, idx: number, layoutOrder: LayoutOrderables) {
...
function byStoningFamily(item: GridItem, idx: number, layoutOrder: LayoutOrderables) {
